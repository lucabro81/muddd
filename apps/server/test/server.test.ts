...
import { loadingWorldState } from '../src/utils.js';
...
describe('Server API Routes', () => {
  ...
  beforeAll(async () => {
    const worldState = loadingWorldState();
  ...
  describe('GET /ws (WebSocket)', () => {
    ...
    it('should accept connection and send welcome message', async () => {
      ...
      expect(welcomeMessage).toMatch(/Welcome to the MUD! Your ID:/); // Verify part of the message
